												...
												<li class="<?php echo \esc_attr($soc_service) ?>">
													<a href="<?php echo \esc_url($soc_link) ?>" target="_blank" rel="noopener">
														...
														?>
															...
															case 'facebook':
															?>
																<svg class="facebook" aria-labelledby="facebook-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
															...
															case 'twitter':
															?>
																<svg class="twitter" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
